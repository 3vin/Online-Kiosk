...
<!-- Collect the nav links, forms, and other content for toggling -->
		...
		<ul class="nav navbar-nav menu__list">
                    ...
                    <li ><a href="traceOrder.jsp" class=" menu__link" class= "menu__item--current">CheckOrder</a></li>
...
<%
    ...
    List<Item> dbItems = (List<Item>)session.getAttribute("dbItems");
    String message = "";
    if(dbItems !=null){
        for(int i=0; i<dbItems.size(); i++){
            message += dbItems.get(i).getDescription()+"</br>" ;
        }
    }
    if(cart==null){
        cart = new Cart();
...
<div class="banner-text">
       ...
       <h1>To Update the Cart <a href="menu.jsp">here</a></h1>
       <h1>To Delete from Cart<a href="delete.jsp">here</a></h1>
       <h1>To check out click <a href="CreateOrderServlet.do">here</a></h1>
