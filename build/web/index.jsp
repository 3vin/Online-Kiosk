...
<html lang="en">
<head>
<title>Online Campus Kiosk</title>
<!-- for-mobile-apps -->
...
<!-- Collect the nav links, forms, and other content for toggling -->
		...
		<ul class="nav navbar-nav menu__list">
                    <li class= "menu__item--current"><a href="index.jsp" class="menu__link">Home</a></li>
...
<div class="gallery-ban" id="gallery">
    <div class="container">
		...
		<div class="wthree_testimonials_grid_main">
                    ...
                    <img src="image/p1.jpg" alt=" " class="img-responsive" />
		</div>
            </li>
            <li>
		<div class="wthree_testimonials_grid_main">
		...
		<div class="wthree_testimonials_grid_main">
                    ...
                    <img src="image/p6.jpg" alt=" " class="img-responsive" />
		</div>
            </li>
        </ul>			
    </div>
	...
	<div class="count-bgcolor-w3ls">
		...
		<i class="fa fa-cutlery" aria-hidden="true"></i>
                    <div class="count hvr-bounce-to-bottom">
                        <div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='15' data-delay='.5' data-increment="5">15</div>
			<span></span>
            ...
            <div class="col-md-4 count-grid">
                <i class="fa fa-users" aria-hidden="true"></i>
                    <div class="count hvr-bounce-to-bottom">
			<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='72' data-delay='.5' data-increment="5">72</div>
			<span></span>
			<h5>Student come back</h5>
                    </div>
            </div>
            <div class="col-md-4 count-grid">
		<i class="fa fa-user-plus" aria-hidden="true"></i>
                    <div class="count hvr-bounce-to-bottom">
			<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='209' data-delay='.5' data-increment="10">209</div>
			<span></span>
			<h5>Site members</h5>
                    </div>
            </div>
...
<div class="services-w3layouts" id="services">
    ...
    <div class="col-md-6 agitsworkw3ls-grid-3">
	<div class="info-imgs">
           <ul>
            <li>
