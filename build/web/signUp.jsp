...
<!-- Collect the nav links, forms, and other content for toggling -->
		...
		<ul class="nav navbar-nav menu__list">
                ...
                <li class="dropdown menu__item">
                    <a href="#" class="dropdown-toggle menu__link" class= "menu__item--current" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">User<span class="caret"></span></a>
...
<div id="content">
	 <h2>New User SingUp</h2>
<form action="RegisterStudentServlet.do" method="POST">
    <label>
        <p>
            Student No:<br><input type="text" id="fullName" name="studNo"/>
        </p>
    </label><br>
    <label>
        <p>
            Name:<br><input type="text" id="cellNo" name="name" maxlength="50"/>
	</p>
    </label><br>
    <label>
        <p>
            Surname:<br><input type="text" id="surname" name="surname"/>
        </p>
    </label><br>
    <label>
        <p>
            Cell No:<br><input type="text" id="surname" name="phoneNo"/>
        </p>
    </label><br>
    <label>
	<p>
            Password:<br><input type="password" id="passw" name="password" maxlength="9"/>
	</p>
    </label><br>
    <label>
	<p>
            Confirm Password:<br><input type="password" id="passw" name="conPass" maxlength="9"/>
	</p>
    </label><br>
	<p>User Role<select name = "role">
            <option> </option>
            <option>Management</option>
            <option>Student</option>
	</select></p>
    <div>
	<p><input type="submit" name="decision" value="SignUp"></p>
    </div>
</form>
