...
<div id="content">
  <h2>Login Details</h2>
    <form action="StaffLoginServlet.do" method="POST">
	<label>
	<p>
            Student:<br><input type="text" id="username" name="studNo">
	</p>
	<label>
	<label>
	<p>
	...
	<label>
	<br>
	<input type="submit" value="Login" id="btnsubmit" name="decision">
	<p><input type="checkbox" id="chkFPIN " name="chkFPIN"> <input type="submit" value="Forgot PIN?" id="btnFPIN" name="decision"></p>
    </form>
